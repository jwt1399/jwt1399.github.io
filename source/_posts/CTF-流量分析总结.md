...
ip.src == ip地址
```
![](https://i.loli.net/2019/07/30/5d3fe9b10d3eb42272.png)

或者手动操作：
点击任意一个符合筛选条件的数据包，找到IPv4下的Source字段。
![](https://i.loli.net/2019/07/30/5d3fe9e5666bc65286.png)
右键点击Source字段，作为过滤器应用 – 选中。
![](https://i.loli.net/2019/07/30/5d3fe9f94ae0d21701.png)
>目的ip筛选

```
ip.dst == ip地址
```
![](https://i.loli.net/2019/07/30/5d3fea0cc1efa69593.png)
或者手动操作：
点击任意一个符合筛选条件的数据包，找到IPv4下的Destination字段，右键点击Source字段，作为过滤器应用 – 选中。
![](https://i.loli.net/2019/07/30/5d3fea228151b95494.png)
...
```
![20190804070139562.png](../images/CTF-流量分析总结/bvEcPu15UrITk49.png)
...
```
![20190804070302262.png](../images/CTF-流量分析总结/NgGpQBEqsTwKJmz.png)
得到flag
`flag{13910407686}`
...
![](https://b2.bmp.ovh/imgs/2019/08/e7393d8d25d8b395.png)
...
从第一个数据包可以看出来：
![](https://b2.bmp.ovh/imgs/2019/08/1455e0e1b7b4b809.png)
...
![](/CTF-流量分析总结/20190807054939495.png)

然后在18:50:42.908737发现黑客再次执行了net user命令
此时回显为：
![](/CTF-流量分析总结/20190807060312931.png)
看来黑客成功添加了管理员用户kaka
确定了大致的作案时间，我们即可使用过滤
```
ip.addr == 192.168.2.20 && http
...
所以可以断定作案时间点在这段时间内
![](/CTF-流量分析总结/20190807061001557.png)
